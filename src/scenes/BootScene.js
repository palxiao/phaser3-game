class BootScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.tilemapTiledJSON("level", "assets/json/level.json");
        this.load.image("tile", "assets/tilemaps/tile.png");
        this.load.image("hero", "assets/images/hero.png");
        this.load.audio('BGM', 'assets/audio/music/Hero_Immortal.mp3')
        this.load.audio('jump', 'assets/audio/8-bit/Jump_03.mp3')
