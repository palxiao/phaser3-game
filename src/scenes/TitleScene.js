class TitleScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.pressX = this.add.text(0, 100, '亲爱的笨蛋，别墨迹了赶紧进游戏好吗', { fontSize: '22px', fill: '#fff' })
        // this.blink = 1000;

        this.startKey = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.SPACE); // 注册一个按键的方法
